...
//! Project version number for EsUtils.
FOUNDATION_EXPORT double EsUtilsVersionNumber;

//! Project version string for EsUtils.
FOUNDATION_EXPORT const unsigned char EsUtilsVersionString[];
